...
OAUTH2_CLIENT_SCOPE = os.getenv("OAUTH2_CLIENT_SCOPE") or "openid profile email roles profile picture email_verified http://newstore/flask-test http://newstore/newstore_id"
